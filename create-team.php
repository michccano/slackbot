    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="addhuddle" class="form-horizontal" >
                <div class="card-body">
                  <p class="text-sm">Complete the following fields to start a new team.</p>
                  <div class="form-group row">

                    <label for="inputEmail3" class="col-sm-2 col-form-label">Title</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="name" placeholder="Email" name="title">
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  <center>
                  <button onclick="addHuddle()" type="button" class="btn btn-info">Create Team</button>
                </center>
                </div>
                <!-- /.card-footer -->
              </form>
