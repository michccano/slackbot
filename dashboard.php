      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="card-text">
                  Check your Team to view, create or answer huddle up.
                </p>
        <div id="huddles" class="row">
              ...
              <div class="card-footer">
                   <a href="create-team.php" class="btn btn-primary">Create a New Team</a>
...
var settings = {
  "url": "http://127.0.0.1:8000/api/team/getTeams/1",
  "method": "GET",
  "timeout": 0,
  "headers": {
...
$.ajax(settings).done(function (response) {
  for(var i=0; i<response.team.length; i++){
        ...
        $("#huddles").append('<div class="col-md-3 "><!-- DIRECT CHAT --><div class="card direct-chat direct-chat-warning card-info" onclick="team()"><div class="card-header"><h3 class="card-title">'+response.team[i].name+'</h3></div><div class="card-body"><p><b>'+response.team[i]["description"]+'</b></p></div></div></div>');
